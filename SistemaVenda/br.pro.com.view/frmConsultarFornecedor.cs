...
namespace SistemaVenda.br.pro.com.view
{
    public partial class frmConsultarFornecedor : Form
    {
        ...
        private void dgFornecedor_DoubleClick(object sender, EventArgs e)
        {
            ...
            cf.txtApelido.Text = dgFornecedor.CurrentRow.Cells[2].Value.ToString();
            cf.mtbCNPJ.Text = dgFornecedor.CurrentRow.Cells[3].Value.ToString();
            cf.txtEmail.Text = dgFornecedor.CurrentRow.Cells[4].Value.ToString();
            cf.mtbTelefone.Text = dgFornecedor.CurrentRow.Cells[5].Value.ToString();
            cf.mtbCelular.Text = dgFornecedor.CurrentRow.Cells[6].Value.ToString();
            cf.mtbCEP.Text = dgFornecedor.CurrentRow.Cells[7].Value.ToString();
            cf.txtLogradouro.Text = dgFornecedor.CurrentRow.Cells[8].Value.ToString();
            cf.txtNumero.Text = dgFornecedor.CurrentRow.Cells[9].Value.ToString();
            cf.txtComplemento.Text = dgFornecedor.CurrentRow.Cells[10].Value.ToString();
            cf.txtBairro.Text = dgFornecedor.CurrentRow.Cells[11].Value.ToString();
            cf.txtCidade.Text = dgFornecedor.CurrentRow.Cells[12].Value.ToString();
