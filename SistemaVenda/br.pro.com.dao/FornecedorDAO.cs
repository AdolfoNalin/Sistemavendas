    ...
    public class FornecedorDAO
    {
        ...
        public void CadastrarFornecedor(Fornecedor obj)
        {
            try
            {
                ...
                string sql = @"insert into tb_fornecedores (nome,vendedor,cnpj,email,telefone,celular,cep,endereco,numero,complemento,bairro,cidade,estado)
values(@nome,@vendedor,@cnpj,@email,@telefone,@celular,@cep,@logradouro,@numero,@complemento,@bairro,@cidade,@estado)";
                ...
                sqlCmd.Parameters.AddWithValue("@vendedor", obj.Apelido);
        ...
        public void EditarFornecedor(Fornecedor obj)
        {
            try
            {
                string sql = @"update tb_fornecedores set nome=@nome,vendedor=@vendedor,cnpj=@cnpj,email=@email,telefone=@telefone,celular=@celular,cep=@cep,endereco=@endereco,numero=@numero,
complemento=@complemento,bairro=@bairro,cidade=@cidade,estado=@estado where id=@id";
                ...
                cmdSql.Parameters.AddWithValue("@vendedor", obj.Apelido);
