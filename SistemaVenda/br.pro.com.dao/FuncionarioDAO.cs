    ...
    public class FuncionarioDAO
    {
        ...
        public void CadastrarFuncionario(Funcionario funcionario)
        {
            try
            {
                ...
                string cmdSql = @"insert into tb_funcionarios(nome,apelido,rg,cpf,email,senha,cargo,nivel_acesso,telefone,celular,cep,endereco,numero,complemento,bairro,cidade,estado,imagem)
values (@nome,@usuario,@rg,@cpf,@email,@senha,@cargo,@nivel_acesso,@telefone,@celular,@cep,@endereco,@numero,@complemento,@bairro,@cidade,@estado,@imagem)";
                ...
                sqlcmd.Parameters.AddWithValue("@usuario", funcionario.Apelido);
                ...
                sqlcmd.Parameters.AddWithValue("@imagem", funcionario.Imagem);
                //sqlcmd.Parameters.AddWithValue("@imagem", funcionario.Imagem);
        ...
        public void EditarFuncionario(Funcionario obj)
        {
            try
            {
                string sqlCmd = @"update tb_funcionarios set nome=@nome,apelido=@apelido,rg=@rg,cpf=@cpf,email=@email,senha=@senha,cargo=@cargo,nivel_acesso=@nivel_acesso,
telefone=@telefone,celular=@celular,cep=@cep,endereco=@endereco,numero=@numero,complemento=@complemento,bairro=@bairro,cidade=@cidade,estado=@estado,imagem=@imagem where id=@id";

                MySqlCommand cmdSql = new MySqlCommand(sqlCmd, connection);
                cmdSql.Parameters.AddWithValue("@nome", obj.Nome);
                cmdSql.Parameters.AddWithValue("@apelido", obj.Apelido);
        ...
        public void ExcluirFuncionario(Funcionario obj)
        {
            try
            {
                string sqlCmd = "delete from tb_funcionarios where id=@id";
        ...
        public bool LogarEmail(string apelido, string senha)
        {
            try
            {
        ...
        public Funcionario ListarNome(string nome)
        {
            try
            {
